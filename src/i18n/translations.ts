export const translations = {
  en: {
    ...
    getStarted: {
      ...
      cli: "Command Line",
      cliDesc: "Use the Mostro CLI for advanced users and automated trading.",
      cliLink: "https://github.com/MostroP2P/mostro-cli", 
      ...
      docsLink: "https://github.com/MostroP2P/mostro",
    },
    donate: {
  ...
  es: {
    ...
    getStarted: {
      ...
      cliDesc: "Usa el CLI de Mostro para usuarios avanzados y trading automatizado.",
      cliLink: "https://github.com/MostroP2P/mostro-cli",
  ...
  it: {
    ...
    getStarted: {
      ...
      mobileLink: "https://github.com/MostroP2P/mobile/releases", 
      cli: "Riga di Comando",
      cliDesc: "Usa la CLI di Mostro per utenti avanzati e trading automatizzato.",
      cliLink: "https://github.com/MostroP2P/mostro-cli",
  ...
  pt: {
    ...
    getStarted: {
      ...
      cliDesc: "Use a CLI do Mostro para usuários avançados e trading automatizado.",
      cliLink: "https://github.com/MostroP2P/mostro-cli",
  ...
  fr: {
    ...
    getStarted: {
      ...
      cliDesc: "Utilisez la CLI Mostro pour les utilisateurs avancés et le trading automatisé.",
      cliLink: "https://github.com/MostroP2P/mostro-cli",
